				...
				<div class="item-box">
					<div class="gallery-wrapper">
						<div class="gallery">
							<div class="thumbnail">
								<ul>
									<li :class="{'on':index === imageIndex}" @click="tableImg(index)" :key="index" v-for="image,index in itemsInfo.ali_images">
                    <img :src="image+'?x-oss-process=image/resize,w_54/quality,Q_90/format,webp'">
							...
							<div class="thumb">
								<ul>
									<li :class="{'on':index === imageIndex}" v-for="image,index in itemsInfo.ali_images">
  ...
  methods:{
    ...
    checkOutHandle(){
      ...
      let provisionalOrder = {
        totalPrice:this.count * this.itemsInfo.totalPrice,
