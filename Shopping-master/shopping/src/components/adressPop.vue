                        ...
                        <div class="dialog-inner js-address-add">
                            <div class="save-address-box">
                                <div class="address-form">
                                    ...
                                    <div class="module-form-row">
                                        <div class="form-item-v3" :class="{'form-invalid-item':phoneError}" @blur="inspectPhone">
                                            <i>手机号</i>
                                            <input type="text" class="js-verify" v-model="receive.phone">
                                            <div class="verify-error"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="dialog-blue-btn big-main-btn disabled-btn js-verify-address" :class="{'isabled-btn':!right}" @click="submitReceiveHandle">
                                        <a>保存</a>
                                    </div>
                                </div>
                            </div>
